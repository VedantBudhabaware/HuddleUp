        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-bold text-white">HuddleUp</h2>
            </div>
            ...
            <a 
              ...
              className="inline-flex items-center gap-2 text-sm text-zinc-400 hover:text-emerald-400 transition-colors duration-200"
            >
              <span>📧</span>
